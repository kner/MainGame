#include "ManBat.h"
    ManBat::ManBat()
	{
  	...
  	void ManBat::SetLeft2Right( char  right )
	{
		Bauer::SetLeft2Right( right );
		bodyC7 = side=='l' ? '/' : '\\';
		bodyC8 = side!='l' ? '/' : '\\';
	}
	void ManBat::ClearHead(int dx)
	{
    ...
    void ManBat::EndHeadAttack()
    {
    	Sleep(200);
    	ClearHead(range+width);
    }
    void ManBat::ShowBite()
    {
